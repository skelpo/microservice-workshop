...
public protocol IdentifiableJWTPayload: JWTKit.JWTPayload {
...
public protocol JWTAuthenticatable: Model, Authenticatable, Content {
    ...
    /// - Throws: Whatever throws in the implementation.
    static func authBody(from request: Request)throws -> EventLoopFuture<AuthBody?>
    ...
    static func authenticate(from payload: Payload, on request: Request)throws -> EventLoopFuture<Self>
    ...
    static func authenticate(from body: AuthBody, on request: Request)throws -> EventLoopFuture<Self>
}
